# Senior Engineering Explanation: `src/services/report.service.js`
...
Key dependencies imported here indicate coupling points: @/services/context, @/lib/db.

Primary exported entry points: headcountReport, payrollSummaryReport, turnoverReport, platformAdminSummary.
