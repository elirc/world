...
Key dependencies imported here indicate coupling points: date-fns, @/lib/db, @/lib/errors, @/lib/audit, @/lib/events, @/services/context.

Primary exported entry points: listLeavePolicies, createLeavePolicy, listLeaveBalances, listLeaveRequests, createLeaveRequest, decideLeaveRequest.
...
Cross-cutting concerns currently visible in this file include: transactional consistency, audit logging, domain event emission.
...
This file currently has approximately 323 lines, which is manageable but should still be monitored for responsibility creep.
