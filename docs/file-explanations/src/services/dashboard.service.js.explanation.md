# Senior Engineering Explanation: `src/services/dashboard.service.js`
...
Key dependencies imported here indicate coupling points: @/lib/db, @/services/context, @/services/report.service.

Primary exported entry points: getDashboardData.
...
This file currently has approximately 65 lines, which is manageable but should still be monitored for responsibility creep.
