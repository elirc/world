# Senior Engineering Explanation: `src/services/org.service.js`
...
Key dependencies imported here indicate coupling points: @/lib/db, @/lib/errors, @/lib/audit, @/services/context, @/services/rbac.service.

Primary exported entry points: listOrganizations, getOrganization, createOrganization, updateOrganization, resolveOrg.
...
This file currently has approximately 103 lines, which is manageable but should still be monitored for responsibility creep.
