# Senior Engineering Explanation: `src/services/context.js`
...
Key dependencies imported here indicate coupling points: @/lib/errors, @/lib/auth.

Primary exported entry points: isPlatformAdmin, requireOrganizationAccess, resolveOrganizationId.
...
This file currently has approximately 37 lines, which is manageable but should still be monitored for responsibility creep.
