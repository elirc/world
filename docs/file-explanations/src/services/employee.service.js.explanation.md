...
Key dependencies imported here indicate coupling points: @/lib/db, @/lib/errors, @/lib/audit, @/lib/events, @/services/context, @/lib/money, @/lib/crypto, @/services/notification.service, @/lib/csv.

Primary exported entry points: listEmployees, getEmployee, createEmployee, updateEmployee, updateOnboardingChecklist, addCompensationRecord, inviteEmployeeNotification, importEmployeesFromCsvRows.
...
This file currently has approximately 484 lines, which is manageable but should still be monitored for responsibility creep.
