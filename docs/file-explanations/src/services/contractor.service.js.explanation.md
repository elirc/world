# Senior Engineering Explanation: `src/services/contractor.service.js`
...
Key dependencies imported here indicate coupling points: @/lib/db, @/lib/errors, @/services/context, @/lib/audit.

Primary exported entry points: listContractors, createContractor, updateContractor, convertContractorToEmployee.
...
Cross-cutting concerns currently visible in this file include: transactional consistency, audit logging.
...
This file currently has approximately 135 lines, which is manageable but should still be monitored for responsibility creep.
