...
Key dependencies imported here indicate coupling points: @/lib/db, @/services/context, @/lib/queue.

Primary exported entry points: createNotification, listNotifications, markNotificationRead, markAllNotificationsRead, getOrganizationUsers.
...
Cross-cutting concerns currently visible in this file include: notification dispatch.
...
This file currently has approximately 85 lines, which is manageable but should still be monitored for responsibility creep.
