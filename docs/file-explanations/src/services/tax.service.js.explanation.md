# Senior Engineering Explanation: `src/services/tax.service.js`
...
Key dependencies imported here indicate coupling points: @/lib/db, @/lib/errors.

Primary exported entry points: listTaxRules, createTaxRule, updateTaxRule.
...
This file currently has approximately 49 lines, which is manageable but should still be monitored for responsibility creep.
