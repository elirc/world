...
Primary exported entry points: toMinorUnits, fromMinorUnits, sumMinor, minorToCurrency.
...
Cross-cutting concerns currently visible in this file include: money math using minor units.
