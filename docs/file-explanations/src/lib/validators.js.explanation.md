...
Key dependencies imported here indicate coupling points: zod.

Primary exported entry points: loginSchema, registerSchema, organizationCreateSchema, organizationUpdateSchema, employeeCreateSchema, employeeUpdateSchema, onboardingUpdateSchema, compensationCreateSchema, contractTemplateCreateSchema, contractCreateSchema, contractUpdateSchema, contractSignSchema, payrollCreateSchema, leavePolicyCreateSchema, leaveRequestCreateSchema, leaveDecisionSchema, taxRuleCreateSchema, taxRuleUpdateSchema, contractorCreateSchema, contractorUpdateSchema, contractorConvertSchema, invoiceGenerateSchema.
...
Cross-cutting concerns currently visible in this file include: schema-based input validation.

## Operational and Maintenance Considerations
This file currently has approximately 203 lines, which is manageable but should still be monitored for responsibility creep.
