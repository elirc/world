# Senior Engineering Explanation: `src/lib/permissions.js`
...
Primary exported entry points: PERMISSIONS, DEFAULT_ROLE_PERMISSIONS.
...
This file currently has approximately 75 lines, which is manageable but should still be monitored for responsibility creep.
