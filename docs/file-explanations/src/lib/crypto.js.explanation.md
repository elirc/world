...
Key dependencies imported here indicate coupling points: node:crypto.

Primary exported entry points: encryptField, decryptField.
...
This file currently has approximately 67 lines, which is manageable but should still be monitored for responsibility creep.
