# Senior Engineering Explanation: `src/components/app-shell.js`
...
Key dependencies imported here indicate coupling points: next/link, @/components/app-nav, @/components/logout-button.

Primary exported entry points: AppShell.
...
This file currently has approximately 28 lines, which is manageable but should still be monitored for responsibility creep.
