# Senior Engineering Explanation: `src/components/panels/payroll-panel.js`
...
Primary exported entry points: PayrollPanel.
...
This file currently has approximately 151 lines, which is manageable but should still be monitored for responsibility creep.
