# Senior Engineering Explanation: `src/app/(app)/payroll/page.js`
...
Key dependencies imported here indicate coupling points: @/components/panels/payroll-panel, @/lib/page-auth, @/services/payroll.service.

Detected imports:
- @/components/panels/payroll-panel
- @/lib/page-auth
