# Senior Engineering Explanation: `src/app/(app)/admin/page.js`
...
Key dependencies imported here indicate coupling points: @/components/panels/admin-panel, @/lib/page-auth, @/services/tax.service, @/services/contract.service, @/services/org.service.

Detected imports:
- @/components/panels/admin-panel
- @/lib/page-auth
...
This file currently has approximately 25 lines, which is manageable but should still be monitored for responsibility creep.
