# Senior Engineering Explanation: `src/app/(app)/employees/page.js`
...
Key dependencies imported here indicate coupling points: @/components/panels/employees-panel, @/lib/page-auth, @/services/employee.service.

Detected imports:
- @/components/panels/employees-panel
- @/lib/page-auth
