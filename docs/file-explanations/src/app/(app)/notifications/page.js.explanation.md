# Senior Engineering Explanation: `src/app/(app)/notifications/page.js`
...
Key dependencies imported here indicate coupling points: @/components/panels/notifications-panel, @/lib/page-auth, @/services/notification.service.

Detected imports:
- @/components/panels/notifications-panel
- @/lib/page-auth
...
This file currently has approximately 19 lines, which is manageable but should still be monitored for responsibility creep.
