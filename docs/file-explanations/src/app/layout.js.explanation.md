...
Key dependencies imported here indicate coupling points: next/font/google.

Primary exported entry points: metadata, RootLayout (default).
...
This file currently has approximately 29 lines, which is manageable but should still be monitored for responsibility creep.
