# Senior Engineering Explanation: `src/app/api/billing/invoices/route.js`
...
Key dependencies imported here indicate coupling points: @/lib/api, @/services/billing.service.
