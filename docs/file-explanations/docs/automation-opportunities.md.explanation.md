# Senior Engineering Explanation: `docs/automation-opportunities.md`
...
This file currently has approximately 98 lines, which is manageable but should still be monitored for responsibility creep.
